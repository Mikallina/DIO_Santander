...
import br.com.santander.santander.dto.*;
...
public class CartaoController {
	...
	public ResponseEntity<Cartao> emitirCartao(@RequestParam String contaC, @RequestParam TipoCartao tipoCartao,
											   @RequestParam(required = false) String diaVencimento, Categoria categoria) {
		...
		if (conta != null) {
			...
			Cartao cartao = cartaoService.criarCartao(conta, tipoCartao, 1234, diaVencimento, categoria);
